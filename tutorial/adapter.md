...
void main() {
  ...
  test('deletes a task through the canonical endpoint', () async {
    ...
    expect(requestedUri.toString(), 'http://localhost:25664/api/tasks/77777777-7777-7777-7777-777777777777');
  });
}
```
...
void main() {
  testWidgets('loads, adds, and removes tasks', (tester) async {
      ...
      switch (loadCount) {
        case 1:
          return const TaskListResponse(
            tasks: [Task(id: '11111111-1111-1111-1111-111111111111', text: 'Learn how to invert binary trees')],
          );
        case 2:
          return const TaskListResponse(
            tasks: [
              Task(id: '11111111-1111-1111-1111-111111111111', text: 'Learn how to invert binary trees'),
    ...
    when(() => api.createTask('Buy milk')).thenAnswer(
      (_) async => const Task(id: '22222222-2222-2222-2222-222222222222', text: 'Buy milk'),
    );
    when(() => api.deleteTask('22222222-2222-2222-2222-222222222222')).thenAnswer((_) async {});
    ...
    await tester.tap(find.byKey(const Key('remove-22222222-2222-2222-2222-222222222222')));
    await tester.pumpAndSettle();
