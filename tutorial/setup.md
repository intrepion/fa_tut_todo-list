...
Before you run the server, create a local Postgres database named `todo_list`, or be ready to override the generated `database_url` value in the root `justfile`.
