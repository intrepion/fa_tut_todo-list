...
For this project, the code layer in this repo owns `parse_task_storage`, `append_task`, `remove_task_by_exact_text`, `format_task_list`, and `serialize_task_storage`, and adapter layer must not reimplement them.
